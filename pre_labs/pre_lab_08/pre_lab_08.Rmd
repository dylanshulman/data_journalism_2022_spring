...
```{r echo=FALSE}
census_api_key("66a84150f4b1de57b9bba6ec99fac50711bf1a81", install=TRUE)
```
...
**Answer**
Yes, Montgomery completely overshadows Calvert with its margin of error. 

Is the difference between Howard and everyone else significant?
**Answer**
Yes, Howard is clearly the leader outside any margin of error. 
...
**Answer**
Somerset County and Caroline County, it seems the change could be within margins of error for Somerset but Caroline County is a little closer, it's plausible that there was a positive change there.  
```{r}
md10 %>%
...
**Answer**
There are only three zip codes with the estimated median household income of less than \$50,000: 21202, 21740 and 21201. However, the margin of error could discount the first two leaving only 21201 is certainly below the \$50,000 mark. 
```{r}
