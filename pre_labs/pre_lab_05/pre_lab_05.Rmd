...
**Answer**
The text is formatted with misspellings and different cases. 
```{r}
...
**Answer**
PHOENIX was changed to Phoenix and WESTMINSTER was changed Westminster
```{r}
...
**Answer**
Changed ABELL to Abell as well as ABERDEEN and aberdeen to Aberdeen. 
```{r}
cleaned_md_loans %>%
...
**Answer**
Not really, just capitalized Abingdon. 
```{r}
cleaned_md_loans <- md_loans %>%
