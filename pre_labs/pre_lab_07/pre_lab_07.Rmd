...
**Answer**
There are several tables describing NAICS codes and their classification. 
### Task 3: Load image
...
**Answer**
I see the HTML behind that website. 
...
**Answer**
I get a glimpse of the HTML tags used like <head> 
```{r}
# read in the html
...
**Answer**
A strange nested folder system. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
There's an HTML table with the title "#NAICSsectors.regular"
### Task 9: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
```{r, echo=FALSE}
...
**Answer**
I get a variety of tibbles from the website, though there's one with the columns and data that we want. 
```{r}
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
List number two has the sector and description data. 
...
**Answer**
I see the sector and description data. 
### Task 14: Load image
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
The sector and description data. 
### Task 16: Load image
...
**Answer**
An r dataframe with the sector and description. 
```{r}
...
**Answer**
It's removed the row with thw source urls and made the column names lowercase. 
```{r}
# Read in all html from table, store all tables on page as nested list of dataframes.
naics_industry <- naics_url %>%
  read_html() %>%
...
**Answer**
A clean r dateframe of the sector and description data. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
I see some tables describing the employment of the various sectors. 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
A glimpse of the HTML behind the website. 
```{r}
...
**Answer**
I see backlog data for employment in an r dataframe. 
```{r}
...
**Answer**
Now it's just the data for November, with clean column names. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Employment table for Mining sector. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
Employment table for Construction sector.
...
**Answer**
I see the titles of different sectors. 
```{r}
...
**Answer**
Nothing appears below the codeblock, but there's now a value assigned with the listed sectors. 
```{r}
...
**Answer**
It printed each sector, just like we did in the previous code individually. 
```{r}
...
**Answer**
The error message appears, because sector_list isn't a thing. 
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
It printed the sectors, even with the "x" name. 
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer**
We didn't define sector_name, so it's running an error. 
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
It printed each number individually. 
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer**
I see a tibble of the NAICS code table.  
```{r}
...
**Answer**
It counted the rows, leaving us with 20 NAICS sectors. 
```{r}
nrow(naics_industry)
```
...
**Answer**
It printed 20 numbers in order. 
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
...
**Answer**
A clean table of the Nov 2021 employment data. 
```{r}
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer**
We have a table with NIACS codes and sector descriptions.
```{r}
# Define url of page we want to scrape
...
**Answer**
It added a column of links to the table. 
```{r}
...
**Answer**
It added another column with the sector xpath, relative to each sector. 
```{r}
...
**Answer**
It removed the Public Administration row. 
```{r}
...
**Answer**
It printed 19 tibbles of each row. 
```{r}
...
**Answer**
I see the url for each sector employment data. 
```{r}
...
**Answer**
I see that we've gotten the full tables of every sector. 
```{r}
...
**Answer**
We've cleaned each data table to just the month we want. 
```{r}
...
**Answer**
Sector and description are now in each row. 
```{r}
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
We now only have data for November, with a cleaned column. 
```{r}
...
**Answer**
We now have only one dataframe with everything we want. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
I see the employment data for the mining sector. Everything looks okay. 
### Task 37: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
There's no employment table, just unemployment rates. 
### Task 39: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Answer**
Our table has replaced the agriculture number with NA. 
```{r}
