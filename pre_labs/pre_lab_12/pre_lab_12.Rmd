...
**Answer**
It looks like it shows county vaccination counts by the day. 
```{r}
...
**Answer**
They're all incredibly similar, often just one or two counts off. 
...
**Answer**
Maybe it's a testing count of DC?
...
**Answer**
The dataframe now includes a ranked column, and it looks like recently some of the lowest ranked days have occurred. 
```{r}
...
**Answer**
Most COVID vaccinations occurred at the beginning of the pandemic and have since declined steeply. 
```{r fig.width=9}
ggplot() +
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer**
The value is sub is still -73.77 on March 6. 
...
**Answer**
The chart shows a trend line of cases for all Maryland counties. 
```{r}
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
The log scale, in my opinion, is even messier. One county is way below the rest.
```{r}
...
**Answer**
The map shows COVID cases as of the current date across Maryland counties. 
```{r}
ggplot() +
