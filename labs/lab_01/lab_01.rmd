...
**A1** The dataframe has 33,336 rows and 58 columns. 
...
**A2** Kanawha County got the most loans at 4273. 
...
**A3** Palm Beach county got the fewest loans at 2. 
...
**A4** Kanawha is West Virginia's most populated county. Palm Beach isn't in West Virginia, it's in Florida, so the loan was filed with the wrong state. 
...
**A5** The Greenbriar Hotel Corporation received an $8,912,202 loan. The business is a resort in the mountains, and the loan retained 500 jobs. 
...
**A6** Governor Jim Justice and his family own the resort, according to Propublica. 
...
**A7** Over 33,336 loans West Virginia doled out 2,600,771,578 dollars. The average loan was a value of 78,016.91 dollars. The median was 20,832, while the minumum loan was 165 and the maximum was 8,912,202. The difference between the median and the mean is interesting to me since it is relatively small in comparison the maximum. This leads me to believe that it was relatively well distributed with large outliers on either end. Also, the sheer size of the total amount is noteworthy to me, though I haven't seen other totals in ppp datasets - that could be small compared to other similarly populated states. 
```{r}
# Write the code to produce your answer here
